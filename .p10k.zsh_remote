# Generated by Powerlevel10k configuration wizard on 2020-07-17 at 23:47 JST.
...
() {
  ...
  # My own color 1 - Green/Blue
  # ROBIN 1
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=41
  ...
  # ROBIN 5 - Change time color to green
  #typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=248
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=36
  ...
  # ROBIN 6 - Changed warning levels
  ...
  # ROBIN 9 - CHange username view for root to red
  #typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=202
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=001
  # Context color in SSH without privileges.
  #typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=180
  # ROBIN 8 - Change remote username segment to blue-green
  #typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=43
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=012
  # Default context color (no privileges, no SSH).
  #typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=180
  # ROBIN 7 - Change username segment to yellow 03
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=03

  # ----------------------  Change color of @ and name!---------------
  # Context format when running with privileges: bold user@hostname.
  # Change different segments to different colors!
  # --------------------------- LOCAL ---------------------
  # Default context format (no privileges, no SSH): user@hostname.
  #typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m'
  # ROBIN 10 - Change look of normal prompt 
  # Local only shows username!
  # Change different segments to different colors!
  # ROBIN 11 - !
  # LOCAL NO ROOT
  #typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%004F@%003Flaptop'
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%013F@%002Flaptop'
  # ROBIN 11 - !
  # add root symbol -   卵 ﮊ     
  # LOCAL ROOT
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE=' %n%013F@%002F%m'
  #
  # --------------------------- REMOTE ---------------------
  ...
  # ROBIN 11 - !
  # REMOTE NO ROOT 
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_TEMPLATE='%n%013F@%012F%m'
  # add root symbol -   卵 ﮊ     
  # REMOTE WITH ROOT
  typeset -g POWERLEVEL9K_CONTEXT_REMOTE_SUDO_TEMPLATE=' %n%013F@%012F%m'
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  # ROBIN 12 - Change color!
  #typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=94
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=36
  # Custom icon.
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  # ROBIN 13 - Change color!
  #typeset -g POWERLEVEL9K_TIME_FOREGROUND=66
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=041
  # Format for the current time: 09:51:02. See `man 3 strftime`.
  # ROBIN 14 - Add day of the week (%a)
